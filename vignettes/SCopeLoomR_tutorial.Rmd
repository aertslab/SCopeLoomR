...
# or install.packages("./SCopeLoomR_0.0.2.14364", source=TRUE, repos=NULL)
```
...
```{r loadData}
library(hdf5r, rjson, utils, methods, base, base64enc) # if installed from source file (SCopeLoomR_0.0.2.14364.tar.gz)
library(SCopeLoomR)
library(SingleCellExperiment)
