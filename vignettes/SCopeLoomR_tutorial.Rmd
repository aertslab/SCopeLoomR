...
# Add Seurat clusterings, Seurat markers (optional) and annotation (optional) for a given resolution (default one if set)
...
add_seurat_clustering(loom = loom
                      , seurat = seurat
                      , seurat.markers.file.path.list = seurat.markers.file.path.list # Optional
                      , default.clustering.resolution = "res.2" # Optional
                      , annotation = seurat.annotation # Optional
                      , annotation.cluster.id.cn = "res.2" # Optional
                      , annotation.cluster.description.cn = "Annotation" # Optional
                      )
```
