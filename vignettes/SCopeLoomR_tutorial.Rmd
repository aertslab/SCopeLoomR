...
# or install.packages("./SCopeLoomR_0.0.2.tar.gz", source=TRUE, repos=NULL)
```
...
```{r loadData}
library(hdf5r, rjson, utils, methods, base, base64enc) # if installed from source file (SCopeLoomR_0.0.2.tar.gz)
library(SCopeLoomR)
library(SingleCellExperiment)
